...
Route::redirect('/yoututbe', '/pzn');

Route::fallback(function (){
    return "404";
});

Route::view('/hello', 'hello', ['name' => 'Elvin']);

Route::get('/hello-again', function (){
    return view('hello', ['name' => 'Elvin']);
});

Route::get('/hello-world', function (){
    return view('hello.world', ['name' => 'Elvin']);
});
...
Route::get('/conflict/elvin', function (){
    return "Conflict Elvin Pratama Nugrahanto";
});
